...
// #define AGOS_SYMBOLS_IMPORT
  ...
  #define AG_GLFW_INCLUDE             "Agos/vendor/GLFW/include/GLFW"
  #define AG_VULKAN_INCLUDE           ""
  #define AG_SPDLOG_INCLUDE           "Agos/vendor/spdlog/include/spdlog/spdlog.h"
  #define AG_EVENTBUS_INCLUDE         "Agos/vendor/EventBus/lib/src/dexode/EventBus.hpp"
  #define AG_GLM_INCLUDE              "Agos/vendor/glm/glm/glm.hpp"
  #define AG_TINY_OBJ_LOADER_INCLUDE  "Agos/vendor/tiny_obj_loader.h"
  #define AG_STB_INCLUDE              "Agos/vendor/stb/stb.h"
